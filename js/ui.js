...
function toggleLoading(isLoading) {
  ...
  if(isLoading === true){
    let buttonIcon = document.querySelector('#button-icon')
    let buttonText = document.querySelector('.button-text');
    let buttonStyle = document.querySelector('#search-button')
    let searchButton = document.querySelector('#search-button')
    buttonStyle.className = "loading-button"
    buttonIcon.className = "fas fa-hourglass-half";
